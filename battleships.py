...
while True:
    try:    
        row_size = int(input("How Many rows would you like?: "))
        if row_size > 12 or row_size < 3:
            print("That number is invalid, Please pick a Number between 3 and 12")
            continue
        else:
          break
    except:
...
while True:
    try:  
        col_size = int(input("How Many Columns would you like?: ")) #number of columns
        if col_size > 12 or col_size < 3:
            print("That number is too large, Please pick a Number between 3 and 12")
            continue
        else:
          break
    except:
